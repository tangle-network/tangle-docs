...
<Callout emoji="⚠️">
  You can claim your airdrop at https://app.tangle.tools/claim. See our [guide at Docs:Claim Airdrop](https://docs.tangle.tools/claim-airdrop/) Note that participants will have 1 year to claim their distribution, **the deadline is April 10 2025.** otherwise the amount is sent to the Tangle Network on-chain treasury.
</Callout>
...
- Visit the releases page on GitHub: https://github.com/webb-tools/tangle/releases
- Download and install the latest version of the Tangle node software.

2. Obtain the mainnet genesis script:

- Download the mainnet genesis script from the following URL: https://github.com/webb-tools/tangle/blob/main/chainspecs/mainnet/tangle-mainnet.json
