...
<Callout emoji="⚠️">
  You can claim your airdrop at https://app.tangle.tools/claim. See our [guide at Docs:Claim Airdrop](https://docs.tangle.tools/docs/claim-airdrop/Genesis) Note that participants will have 1 year to claim their distribution, **the deadline is April 10 2025.** otherwise the amount is sent to the Tangle Network on-chain treasury.
</Callout>
