...
See [Hardware](./docs/node/hardware.mdx) and [Getting Started with Validating](./node/validator/requirements.mdx) for more information.
...
Monitoring is critical for success as a node operator. See our full [Monitoring guide](./node/monitoring/quickstart.mdx)
...
Alerting is critical for your success as a node operator, see our full guide to using our recommended AlertManager (./node/monitoring/alert-manager.mdx)
...
For full support, see our guides on [Logging](./node/monitoring/loki.mdx).
