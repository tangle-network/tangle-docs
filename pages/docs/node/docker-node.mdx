...
We need to generate the required keys for our node. For more information on these keys, please see the [Required Keys](../validator/requirements/#2-generate-your-keys-and-import-them-to-the-keystore) section.
