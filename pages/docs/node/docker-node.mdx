...
<Callout type="info">
  For an overview of the above flags, please refer to the [Substrate node-template CLI Tool](https://docs.substrate.io/reference/command-line-tools/node-template) page of our documentation.
</Callout>
...
We need to generate the required keys for our node. For more information on these keys, please see the [Required Keys](./docs/node/validator/requirements/#2-generate-your-keys-and-import-them-to-the-keystore) section.
