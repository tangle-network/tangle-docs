...
This guide provides a quickstart for anyone looking to run a Tangle Network node and participate in mainnet. Before following this guide, please ensure your machine meets the [hardware requirements](https://docs.tangle.tools/docs/node/hardware/) and has the necessary dependencies installed.
...
Monitoring your node is critical. Refer to the [monitoring docs](https://docs.tangle.tools/docs/node/monitoring/quickstart/) for instructions on setting up monitoring.
