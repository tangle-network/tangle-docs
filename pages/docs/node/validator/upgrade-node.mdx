...
- Stay informed [about new releases](https://github.com/webb-tools/tangle/) from the Tangle Network community. We publish these on the [Webb twitter, and in Discord.](../community)
...
For additional support, [join our Validator channel in Discord.](../community)
