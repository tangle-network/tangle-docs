...
compiled the Tangle binary. If you have not done so, please refer to the [Requirements](./hardware/) page.
...
config, this guide uses automated keys and it is not recommended to run a validator using this setup long term, refer to [Deploy with Systemd](../validator/systemd/) guide
