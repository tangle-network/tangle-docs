...
config, this guide uses automated keys and it is not recommended to run a validator using this setup long term, refer to [Deploy with Systemd](./systemd/) guide
