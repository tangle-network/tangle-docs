...
| Variable        | Value                      |
| --------------- | -------------------------- |
| Network         | Tangle Network (Mainnet)   |
| Chain ID        | 4006                       |
| Asset Decimals  | 18                         |
| Token Symbol    | TNT                        |
...
Address for Tangle Network are prefixed with `tg` like `tgGmBRR5yM53bvq8tTzgsUirpPtfCXngYYU7uiihmWFJhmYGM`.

## Tangle Testnet

Developer tools may require specific configurations for the Tangle Testnet. Use the following details:

| Variable        | Value                              |
| --------------- | ---------------------------------- |
| Network         | Tangle Testnet                     |
| Chain ID        | 4007                               |
| Asset Decimals  | 18                                 |
| Token Symbol    | tTNT                               |
| Public RPC URLs | `https://testnet-rpc.tangle.tools` |
| Public WSS URLs | `wss://testnet-rpc.tangle.tools`   |
| Faucet          | `https://faucet.webb.tools/`       |

Address for Tangle Testnet are prefixed with `tt` like `ttFELSU4MTyzpfsgZ9tFinrmox7pV7nF1BLbfYjsu4rfDYM74`.
