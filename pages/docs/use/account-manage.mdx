...
6. **Load the Account Page in Polkadot Apps**
   ...
   ![Account List in Polkadot Apps](../../../images/use/account-app-list.png)

   - Now you have a working account, and can use it in Polkadot Apps.

   ![Click the Account Tab](../../../images/use/account-tab.png)

   - Go to the Account tab.
   - Use your account to conduct transactions or other activities.

   ![Accounts Page in Polkadot Apps](../../../images/use/account-tab-in-page.png)
