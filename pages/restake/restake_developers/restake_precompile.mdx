...
The latest version of the precompile can be found [here](https://github.com/webb-tools/tangle/blob/main/precompiles/multi-asset-delegation/MultiAssetDelegation.sol).
