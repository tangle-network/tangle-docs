...
Learn more about how to execute these functions in [Join a Liquid Staking Pool](./lst-pool-join.mdx).

For detailed instructions on creating a pool, visit the [Creating a Liquid Staking Pool](./lst-pool-create.mdx).
