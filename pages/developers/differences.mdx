...
| Metric                      | Tangle | Eigenlayer | Karak | Symbiotic | Sollayer |
| --------------------------- | ------ | ---------- | ----- | --------- | -------- |
| AVS Language                | `Rust` | `Golang`   | -     | -         | -        |
...
![Eigenlayer vs Tangle](/images/architecture/eigenlayer.png)
...
![Tangle Architecture](/images/architecture/tangle.png)
