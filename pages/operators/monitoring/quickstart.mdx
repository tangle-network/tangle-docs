...
review the **How to run an Tangle node** setup guide [here](https://docs.tangle.tools/node/quickstart/). It is important to note that
...
Follow the instructions [here](https://docs.tangle.tools/node/monitoring/prometheus/) to start the prometheus node exporter.
