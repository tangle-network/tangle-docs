...
review the **Tangle Node Quickstart** setup guide [here](https://docs.tangle.tools/node/monitoring/quickstart/). It is important to note that
...
visit the official docs site [here](https://prometheus.io/introduction/overview/).
