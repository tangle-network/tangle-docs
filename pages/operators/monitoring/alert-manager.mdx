...
visit the official docs site [here](https://prometheus.io/alerting/latest/alertmanager).

### Getting Started

Start by downloading the latest releases of the [AlertManager](https://prometheus.io/alerting/latest/alertmanager).
