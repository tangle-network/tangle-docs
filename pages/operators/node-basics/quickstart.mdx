...
This guide provides a quickstart for anyone looking to run a Tangle Network node and participate in mainnet. Before following this guide, please ensure your machine meets the [hardware requirements](https://docs.tangle.tools/node/hardware/) and has the necessary dependencies installed.

## 1. Update to Latest Node Release

Visit the [Tangle releases page](https://github.com/webb-tools/tangle/releases) and download the latest version of the `tangle` binary for your operating system. For example, for release v1.0.0 on Linux you would run:
...
Please see our new **[Start Validating guide.](https://docs.tangle.tools/node/validator/requirements/)**

## Monitoring

Monitoring your node is critical. Refer to the [monitoring docs](https://docs.tangle.tools/node/monitoring/quickstart/) for instructions on setting up monitoring.
