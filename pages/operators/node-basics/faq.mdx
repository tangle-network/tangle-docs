...
See [Hardware](https://docs.tangle.tools/node/hardware/) and [Getting Started with Validating](https://docs.tangle.tools/node/validator/requirements/) for more information.
...
Monitoring is critical for success as a node operator. See our full [Monitoring guide](https://docs.tangle.tools/node/monitoring/quickstart/)
...
Alerting is critical for your success as a node operator, see our full guide to using our recommended [AlertManager](https://docs.tangle.tools/node/monitoring/alert-manager/)
...
For full support, see our guides on [Logging](https://docs.tangle.tools/node/monitoring/loki/).
...
Setting an identity on-chain will help to identify your node and attract delegations. You can set an identity by following the instructions on [Polkadot's Identity Documentation](https://wiki.polkadot.network/learn-identity)
